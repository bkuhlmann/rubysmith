  ...
  describe "#call" do
    ...
    context "when enabled with Markdown format" do
      let :test_configuration do
        configuration.minimize.merge build_contributions: true, documentation_format: "md"
      end
    ...
    context "when enabled with ASCII Doc format" do
      let :test_configuration do
        configuration.minimize.merge build_contributions: true, documentation_format: "adoc"
      end
